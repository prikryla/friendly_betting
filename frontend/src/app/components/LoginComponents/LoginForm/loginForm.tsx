  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <form className="flex flex-col gap-16" onSubmit={handleSubmit}>
        <label htmlFor={loginData.email} className="flex flex-col gap-2">
          E-mail
          <input
            name="email"
            ...
            className="w-80 lg:w-96 h-16 border rounded-2xl text-xl font-normal border-line indent-5 "
          />
        </label>
        <label htmlFor={loginData.password} className="flex flex-col gap-2">
          Heslo
          <input
            name="password"
